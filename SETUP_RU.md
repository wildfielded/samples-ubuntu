# Шпоры по отработанным методам установки, настройки и управления ОС Ubuntu #
...
[4. Замена концов Win-строк на UNIX-строки](#замена-в-текстовом-файле-windows-строк-в-unix-строки)    
